...
const getCustomers = (customerArray, countryArray) => {
    ...
    customerArray.forEach((customer) => {
        ...
        const promise = new Promise((resolve, reject) => {
            ...
            if ((typeof customerId !== 'undefined') && (typeof customer.verified !== 'undefined') && (customer.verified)) {
                let elemFindID = countryArray.find(state => (state.id === customerId));
        ...
        bufferArray.push(promise);
    });
    return Promise.allSettled(bufferArray);
};
